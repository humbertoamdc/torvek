...
pub enum IsReadyError {
    Status503(crate::models::IsReady503Response),
    DefaultResponse(String),
    UnknownValue(serde_json::Value),
}
...
) -> Result<crate::models::GetVersion200Response, Error<GetVersionError>> {
...
pub async fn is_alive(
    configuration: &configuration::Configuration,
) -> Result<crate::models::IsAlive200Response, Error<IsAliveError>> {
    let local_var_client = &configuration.client;
...
pub async fn is_ready(
    configuration: &configuration::Configuration,
) -> Result<crate::models::IsAlive200Response, Error<IsReadyError>> {
    let local_var_client = &configuration.client;
