...
pub async fn get_courier_message(
    ...
    id: &str,
) -> Result<crate::models::Message, Error<GetCourierMessageError>> {
...
pub async fn list_courier_messages(
    ...
    status: Option<crate::models::CourierMessageStatus>,
    recipient: Option<&str>,
) -> Result<Vec<crate::models::Message>, Error<ListCourierMessagesError>> {
    let local_var_client = &configuration.client;
